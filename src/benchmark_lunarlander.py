...
import muzero
import games.lunarlander

def run_benchmarks():
    # --- CONFIGURAZIONE GLOBALE LUNARLANDER ---
    GAME_NAME = "lunarlander"
    NUM_SEEDS = 2  # Number of runs per experiment (32 for exact paper replication)
    DEFAULT_TRAINING_STEPS = 30000 # Standard duration for experiments without pre-training
    ...
    for exp_name, exp_config in experiments.items():
        ...
        for seed in range(NUM_SEEDS):
            ...
            config = games.lunarlander.MuZeroConfig()
            ...
            try:
                ...
                print(f"!!! Error during seed {seed} of {exp_name}: {e}")
                import traceback
                traceback.print_exc()
